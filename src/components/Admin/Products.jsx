...
export default function Products() {
  ...
  return (
    <div className="m-2 md:mt-20 mt-24 p-2 md:p-10 bg-white rounded-3xl">
            ...
            {plans.map((plan) => (
              <>
                ...
                >
                  ...
                  <td class="px-6 py-4">{plan.stripePlanId}</td>
                  <td class="px-6 py-4">
                  ...
                  <td class="px-6 py-4">{plan.monthlyprice}</td>
                  <td class="px-6 py-4">{plan.yearlyprice}</td>
                  <td class="px-6 py-4">{plan.created_at}</td>

                  <td class="px-6 py-4">
                    <div className="flex flex-row">
                      <Link
                        onClick={(ev) => ontoggle(plan)}
                        class="font-medium text-blue-600 dark:text-blue-500 hover:underline"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
      ...
      {toggleForm && <PlansForm plan={editPlan} unToggleModal={unToggle} />}
    </div>
  );
}
